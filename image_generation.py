...
USER_PHOTO_PATH = os.environ.get("USER_PHOTO_PATH", "images/placeholder.jpg")
...
def generateBaseOutfit(images, recommendation, filename):
    ...
    prompt = f"""
            ...
            - hems
            - fabric texture
            Make sure the colours of the garments aren't dull, they should be the same colour as the reference image!

            Do not invent or remove any garment details. Don't add any folds to the t-shirt. Do not tuck in the t-shirt!
    ...
    print("Status:", postImage.status_code)
    print("Response:", postImage.text)
